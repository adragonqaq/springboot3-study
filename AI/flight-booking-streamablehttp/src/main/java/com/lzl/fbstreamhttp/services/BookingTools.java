package com.lzl.fbstreamhttp.services;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.annotation.JsonInclude.Include;
import com.lzl.fbstreamhttp.data.BookingStatus;
...
public class BookingTools {
	...
	@McpTool(description = "获取机票预定详细信息")
	BookingDetails getBookingDetails( @McpToolParam(description = "预定号")
									  String bookingNumber,
									  @McpToolParam(description = "姓名")
									  String name) {
		try {
...
//	}
	...
	@McpTool(description = "取消机票预定")
	String cancelBooking(@McpToolParam(description = "预定号")
						 String bookingNumber,
						 @McpToolParam(description = "姓名")
						 String name) {
